          ...
          {t.offer.items.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className="bg-[#FDFBF7] p-8 sm:p-10 rounded-3xl border border-[#2C1E16]/5 transition-transform hover:-translate-y-1.5"
              >
                <div className="w-12 h-12 rounded-full bg-[#F5F2EB] flex items-center justify-center text-[#C86F54] mb-6 shadow-sm">
