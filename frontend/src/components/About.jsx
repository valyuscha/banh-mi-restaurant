...
const About = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-12 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="grid grid-cols-3 gap-6 mt-10 pt-8 border-t border-[#2C1E16]/10">
            {t.about.stats.map((s, i) => (
              <div key={i} data-testid={`about-stat-${i}`}>
                <p className="font-serif text-2xl sm:text-3xl text-[#C86F54]">{s.value}</p>
        ...
        <Reveal delay={0.15} className="order-1 lg:order-2">
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 hidden sm:block bg-[#2C1E16] text-[#FDFBF7] rounded-2xl px-7 py-5 shadow-xl">
              ...
              <p className="text-xs uppercase tracking-[0.2em] text-[#E8B79E] mt-1">
                Świętego Jana 30
              </p>
            </div>
          </div>
